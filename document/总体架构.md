...
a. 前端返回pro_ID，查询pro_product表中brd_id匹配表brd_brand得到name_en品牌名,返回值包含返回参数信息，长宽高在  pck_package_info中
...
### 4.5商品状态改变（入仓[0-1]、出仓[1-0]、下架[2-1]、上架[1-2]）
...
| STS_CD               | char(1)       | 是           | 0-待入仓     1-已入仓     2-在架中 |
