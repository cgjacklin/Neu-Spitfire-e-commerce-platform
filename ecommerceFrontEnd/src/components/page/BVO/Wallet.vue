  ...
  <div>
    ...
    <div v-show="mainShow" class="main-box-top">
          ...
          <el-popover placement="right" width="380" v-model="visible1">
            <div class="password">
              <el-input
                ...
                show-password
              ></el-input>
              <el-button type="danger" size="small" @click="DepositPass">Sure</el-button>
            </div>
            <el-button style="width:10rem" type="danger" slot="reference" round plain>Deposit</el-button>
          </el-popover>
      ...
      <div class="main-box-top">
        <el-link style="font-size:18px" :underline="false" type="success">Deposit Records</el-link>
    ...
    <el-dialog title="Deposit" :visible.sync="dialogDeposit" width="30%">
      <span slot="footer" class="dialog-footer">
        ...
        <el-button type="danger" @click="dialogDeposit= false">sure</el-button>
      </span>
    </el-dialog>
